...
-(void) viewWillAppear:(BOOL)animated
{
    ...
    self.navigationItem.title = @"控制器上的编辑视图";
...
-(void) makeFrame
{
    self.contact.frame = CGRectMake(20, 300, 50, 18);
    self.contactprompt.frame = CGRectMake(self.contact.viewRightX+2, 303, SCREENWIDTH-self.contact.viewRightX, 18);
    ...
    tfphone.keyboardType = UIKeyboardTypeNumberPad;
    [self.view addSubview:tfphone];
    tfphone.frame = CGRectMake(20, 30, SCREENWIDTH-20, 18);
}
